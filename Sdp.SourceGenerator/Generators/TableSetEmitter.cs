...
internal static class TableSetEmitter
{
    ...
    private static string FkSetKey(FkBranch branch, string propertyTypeFullyQualifiedName)
    {
        ...
        string indent)
    {
        ...
        if (switchBranches.Count > 0)
        {
            ...
            // 조건 프로퍼티 타입은 분석 측(AnalyzeFkParameters)이 해석해 FkBranch 에 담아 준다. 재조회하지 않는다.
